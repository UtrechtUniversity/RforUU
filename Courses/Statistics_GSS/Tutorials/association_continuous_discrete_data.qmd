...
In this practical, you will investigate associations between numerical variables using correlation analysis. You will work with pairs of variables that may be continuous, ordinal, or show non-linear relationships, and you will learn how to choose an appropriate correlation method for each situation. Specifically, you will calculate and interpret three commonly used correlation measures:
...
Pearson's correlation coefficient between the number of agroecological practices and plant diversity is equal to `{r} round(pearson_mowing_CMB, 2)`.
:::
::::
