...
**RStudio** is an [integrated development environment]{.underline} (IDE) for R (and other languages such as Python) developed by [Posit](https://posit.co/), an open-source data science company. With RStudio, you can easily write your own scripts, run R code, manage your workspace, install and load R packages, view graphical output, and much more! You can download RStudio on the [Posit website](https://posit.co/).
...
::: callout-important
## Always comment and save your R script!
...
You can save an R script (`.R` file) by opening the File menu and click on "Save as...".
:::
...
-   *Double (numeric)*: numbers with a decimal value (e.g., 17.8)
-   *Integer (numeric)*: numbers without a decimal value (e.g., 18)
...
plot(x = x4$Var1,
     y = x4$Var2,
     type = "l", #This is the letter "l" for line
     xlab = "Variable 1",
     ylab = "Variable 2",
     col = "blue")
