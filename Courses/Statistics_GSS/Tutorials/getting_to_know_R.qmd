...
-   *Factor*: data type used in statistical modelling to specify what are the factors in the model (categorical variables with a defined set of
    categories, called ‘levels’ in R)
